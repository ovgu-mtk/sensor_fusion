...
if gpus:
    if len(gpus) == 1:
        ...
        try:
            tf.config.experimental.set_visible_devices(gpus[3], 'GPU')  # Force TensorFlow to use GPU 1
...
if __name__ == "__main__":
    ...
    for idx, model_config in enumerate(models_to_train):
        ...
        try:
            # Erstelle DataGeneratoren pro Modell mit dem passenden Flag
